...
import Smile1 from "../src/images/smile1.jpg";
import Cab7 from "../src/images/Mark-Buddha.jpg.png";
...
<div className="notreal container-fluid mb-5 d-flex justify-content-center">
  ...
  <div className="card-footer ">Choose the size and colour of your veneers to achieve a true Hollywood smile
 </div>
</div>
...
<h2 className="beautiful text-center brace " >
 ...
 <h3 className="text-center beautiful space"><br/><br/><br/><br/> <br/>Veneers Procedure    </h3>
  ...
  <div className="container mt-5  ">
    ...
    <div class="card-footer "> At your first appointment, you will meet with your dentist to discuss your treatment and start the veneers process by designing your smile. You will decide on the appearance of your veneers and pick the shade you want, whether that be a white “Hollywood smile” or a more natural-looking finish.
  </div>
  </div>
     </div>
     <div className="col-lg-6 col-md-6 col-12  ">
    ...
    <div class="card-footer ">Next, appointment 2 will allow you to preview your smile in your mouth. You will be able to envision exactly how your new veneers will look, giving you your ideal smile
      </div>
  </div>
     </div>
    </div>
...
export default Smilemakeoverandveneers ;     