...
<div className ='row'>
  <div className ="col-10 mx-auto text-center">
   ...
   <h5 className="beautiful">I had my consultation with Dr Buddha. He was by far the most professional compared to the other clinics I went to for consultations this week. His colleague Lisa was very friendly and helpful.<hr/>

Sue Green</h5>
    </div>
     <div className="col-md-4 col-10 mx-auto">
   <h5 className="beautiful" >So I went to see myclinique this week for a Invisalign consultation and I was very impressed, I saw a lady called Lisa and a man called Mark, I told them what a great consultation it was because I was informed of lot's of options and were given lots of information about Invisalign that other clinics never told me before.

   <hr/> Natalia Marjovic</h5>
    </div>
     <div className="col-md-4 col-10 mx-auto">
  <h5  className="beautiful">MyClinique is the best clinic in Northampton my daughter got her Invisalign here with the gentleman and I get my anti-wrinkle injections here.
...
Discover the power of dental implants<br/><br/>
</h2>
...
<div className =" dis row d-flex justify-content-center">
  ...
  <div className="card-footer bg-primary hard">Dental implants can last upto 25 years.
  ...
  <div className="card-footer bg-primary hard">Dental implants are extremely strong and durable
 ...
 <div className="hard"> A better alternative to dentures, you can eat what you like</div>
 </div>
</div>
...
<div className ='row'>
  <div className ="col-10 mx-auto text-center">
    ...
    <h3 className="line" >Single Tooth <br/>implants</h3>
      <p> <br/><br/>Single dental implants are used to replace one or missing teeth.<br/><br/></p>
